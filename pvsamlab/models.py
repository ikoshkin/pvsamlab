...
from pvsamlab.utils import log_info, log_error, fetch_weather_file, mw_to_kw, w_to_kw, calculate_capacity_factor
...
class SolarResource:
    def __init__(self, solar_resource_file=None, solar_resource_data=None, lat=None, lon=None, use_wf_albedo=0, dataset_type="TMY"):
        ...
        self.weather_folder = "weather_files"
        ...
        if solar_resource_file:
            ...
            self.solar_resource_file = os.path.join(self.weather_folder, "default_weather.csv")
